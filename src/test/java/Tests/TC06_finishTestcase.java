...
public class TC06_finishTestcase {
    ...
    @Test
    public static void finishingOrderTC() throws IOException {
        //TODO : login steps
        ...
        //TODO goto finishing order page
        new P05_OveviewPage(getDriver())
                .clicOnFinishButton();
        Assert.assertTrue(new P06_finishingOrder(getDriver()).checkOnVisiblityofMessage());
